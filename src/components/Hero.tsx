...
const Hero = () => {
  ...
  return <section className="pt-28 pb-12 md:pt-36 md:pb-20 bg-gradient-to-br from-master-blue to-master-blue/90 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 py-[37px]">
